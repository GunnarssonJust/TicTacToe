...
public class Four_FourActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "Four_FourActivity";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.four_scale_menu, menu);
        return true;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = Four_FourActivity.this;
        ...
        //creating an alternative look of the toast messages
        Toast toast = new Toast(context);
        toast.setDuration(Toast.LENGTH_LONG);


        //setOnClickListeners for the game fields
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
        ...
        btnplayerreset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                My_Four_DialogFragment dialog = new My_Four_DialogFragment();
