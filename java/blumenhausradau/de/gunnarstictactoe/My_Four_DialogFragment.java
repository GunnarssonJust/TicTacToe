...
public class My_Four_DialogFragment extends DialogFragment {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(spieler1.equals("")|| spieler2.equals("")){
                    ...
                    ((Four_FourActivity)getActivity()).username1.setText(spieler1);
                    ((Four_FourActivity)getActivity()).username2.setText(spieler2);
                    getDialog().dismiss();
                }
